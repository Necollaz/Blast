...
const DEFAULT_SUPER_TILE_LINE_MIN_GROUP_SIZE = 4;
const DEFAULT_SUPER_TILE_RADIUS_MIN_GROUP_SIZE = 5;
const DEFAULT_SUPER_TILE_CLEAR_BOARD_MIN_GROUP_SIZE = 6;
const DEFAULT_SUPER_TILE_RADIUS = 1;
...
export const DEFAULT_GAME_CONFIG: GameConfig = {
    ...
    superTileLineMinGroupSize: DEFAULT_SUPER_TILE_LINE_MIN_GROUP_SIZE,
    superTileRadiusMinGroupSize: DEFAULT_SUPER_TILE_RADIUS_MIN_GROUP_SIZE,
    superTileClearBoardMinGroupSize: DEFAULT_SUPER_TILE_CLEAR_BOARD_MIN_GROUP_SIZE,
    superTileRadius: DEFAULT_SUPER_TILE_RADIUS,
};